...
// Type: EvComm.CheckCurrentUnitCost
...
{
  public class CheckCurrentUnitCost
  {
    ...
    public void InitCheckCurrentUnitCost(string stationId, string chargerId)
    {
    ...
    public void SetDataSendCheckCurrentUnitCost(string send_date, string create_date)
    {
