...
// Type: EvComm.HttpJSonRequest.JSonAlarmHistory
...
namespace EvChargerUI.Services.EvComm.HttpJsonRequest
{
  public class JSonAlarmHistory
  {
    ...
    [JsonProperty(PropertyName = "alarm_type")]
    public string alarm_type { get; set; }

    [JsonProperty(PropertyName = "alarm_date")]
    public string alarm_date { get; set; }

    [JsonProperty(PropertyName = "alarm_code")]
