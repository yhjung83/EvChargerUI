...
{
    public class RightChargerViewModel : ChargerViewModel
    {
        public RightChargerViewModel(int channelNo, MainViewModel parentViewModel, Charger charger) : base(channelNo, parentViewModel, charger)
        {
        ...
        {
            ConnectorImage = "/Images/img_ready_connector_r.png";
            UsableButtonImage = "/Images/btn_usable_r.png";
